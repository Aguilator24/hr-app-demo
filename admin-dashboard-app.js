...
function AdminDashboard() {
  try {
    ...
    const renderContent = () => {
      switch (activeTab) {
        case 'dashboard':
          return <AdminStats user={currentUser} />;
        case 'employees':
          return <EmployeeManagement user={currentUser} />;
        case 'time-reports':
          return <TimeReports user={currentUser} />;
        case 'vacation-management':
          return <VacationManagement user={currentUser} />;
    ...
    return (
      <div className="min-h-screen bg-[var(--bg-secondary)]" data-name="admin-dashboard" data-file="admin-dashboard-app.js">
